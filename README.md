# CoderSchool Ruby Homework 2

This is a DEMO app for CoderSchool Ruby Homework 2.

### Test Data

  - a@example.com / asdf ([login](/sessions/new?email=a@example.com&password=asdf))
  - b@example.com / asdf ([login](/sessions/new?email=b@example.com&password=asdf))
...
* [x] Implement "Users" link takes the user to a page that lists all users. Next to/under each user, provide a link to "Add As Friend" to add the user to your list of friends.
...
* [x] Implement "Sent Messages" page. It lists messages you have sent. Each message should display at what time it was read by the recipient, or "unread". The user cannot read the contents of the messages.
